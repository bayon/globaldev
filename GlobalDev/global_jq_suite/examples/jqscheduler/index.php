...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <style type="text">
        html, body {
			...
			padding: 0;
		    overflow: hidden;	/* Remove scroll bars on browser window redmond */
	        font-size: 62.5%;
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="../../themes/ui.jqscheduler.css" />
  ...
  <body>
 <div id="calendar" style="height: 300px;margin: 0 auto;width:600px;font-size: 0.8em;"></div> 
