...
class RestDownloader {
	...
	var $secret ="!9966youllNeverKnowEat1100!";
	...
	function returnParameter() {
		$a_methods = array('Invalid Request Try:', 'another method');
	...
	function getAllUsers(){
		...
		$result = "You reached api_1.php";
		if($_POST["secret"]==$this->secret){
				$result .= " and you appear to know the secret code."; 
		}
