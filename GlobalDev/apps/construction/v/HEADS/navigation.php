...
function navigation($user) {
	...
	<input id='nav2'  type='submit' class='nav_buttons main_gradient' name='navigation' value='jobs'/>
	<input id='nav3'  type='submit' class='nav_buttons main_gradient' name='navigation' value='items'/>
	<input id='nav4'  type='submit' class='nav_buttons main_gradient' name='navigation' value='tasks'/>
...
function createHeader($user) {
	...
	$html .= "<div id='site_name'>construction<a id='logout' href='".BASE_URL."index.php?controller=login.php&method=logout'   >Log Out</a> </div>";
	$html .= "</div>";
